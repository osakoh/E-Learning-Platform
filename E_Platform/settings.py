...
SECRET_KEY = 'o8l97&wz%l35k#g9duk9pb)zc7l#94&=gma%xka*x6bp27nz-('
...
STATIC_URL = '/static/'
# location of 'static' in project folder E_Platform
STATICFILES_DIRS = [
    BASE_DIR, "E_Platform/static"
]

# Media settings
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # creates a 'media' folder in the root dir (E_Platform) directory
